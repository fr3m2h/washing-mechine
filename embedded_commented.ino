...
/* Voici une version du code avec toute la partie connection WiFi et transmission de donnée commentée.
Ce code fonctionne pour afficher la disponibilité d'une machine en revanche
*/
